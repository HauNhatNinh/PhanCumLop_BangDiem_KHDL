...
"""
╔══════════════════════════════════════════════════════════════════╗
║     PHÂN CỤM SINH VIÊN THEO NĂNG LỰC HỌC TẬP                 ║
║     K-Means + Hierarchical Clustering                          ║
║     Môn: Khoa Học Dữ Liệu                                     ║
╚══════════════════════════════════════════════════════════════════╝

Cách dùng:
    1. Đặt file Excel vào cùng thư mục với script này
    2. Chạy: python phan_cum_sinh_vien.py
    3. Kết quả: 1 biểu đồ tròn + 3 file .xlsx (Giỏi, Khá, TB-Yếu)
"""
